...
type
    ...
    private
        ...
        FDirThread : TThread;
        FTimer :     TTimer; //TOldTimer originalmente(lembrar disso para o caso de importação para XPLib);
...
var
    ...
    sMsgNotifExceptionWait :   ansistring = 'Exceção enquanto esperando por notificação';
    sMsgNotifExceptionCreate : ansistring = 'Exceção enquanto criando thread';
    sMsgNotifExceptionTerminate : ansistring = 'Exceção enquanto terminando thread';
    sMsgNotifExceptionTimeOut : ansistring = 'Sistema de notificação de arquivo sem resposta durante início/fim';
