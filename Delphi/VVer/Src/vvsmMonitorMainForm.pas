...
begin
	...
	{$ELSE}
	Self.Caption := Self.Caption + ' Versão: ' + VVSMMainDM.fvVersion.FileVersion;
	{$ENDIF}
...
begin
	case MessageDlg('Deseja baixar os pacotes do computador primário agora?', mtConfirmation, [mbYes, mbNo], 0) of
		mrYes: begin
				MessageDlg('Esta operação pode demorar alguns minutos.'#13#10 + 'Ao final um aviso lhe será enviado'#13#10 +
