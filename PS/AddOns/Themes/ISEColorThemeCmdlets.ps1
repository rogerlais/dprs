<#
 ...
 Description :  A collection of Powershell cmdlets that expand the PowerShell ISE themeing capability to the command line. These cmdlets allow
                you to import, remove, and apply native xml and registry based ISE themes without the need to format and translate the xml ARGB
